...
![plot of chunk mo_lm_2x2w_model_2x2w](mo_lm_2x2w_model_2x2w-1.png)
...
``` r
lm_y <- lm(y ~ w1*x1 + w2*x2 + c1 + c2, dat)
```
...
![plot of chunk mo_lm_2x2w_plot_cond1](mo_lm_2x2w_plot_cond1-1.png)
...
![plot of chunk mo_lm_2x2w_plot_cond2](mo_lm_2x2w_plot_cond2-1.png)
...
![plot of chunk mo_lm_2x2w_plot_cond1_tumble](mo_lm_2x2w_plot_cond1_tumble-1.png)
...
![plot of chunk mo_lm_2x2w_plot_cond2_tumble](mo_lm_2x2w_plot_cond2_tumble-1.png)

In this example, the distributions of `x2`
for the three levels of moderator `w2`
are similar.

However, the distributions of `x1`
...
of `w1` on the effect of `x1`. For `x2`,
...
![plot of chunk mo_lm_2x2w_plot_std1](mo_lm_2x2w_plot_std1-1.png)
...
![plot of chunk mo_lm_2x2w_plot_std2](mo_lm_2x2w_plot_std2-1.png)
...
![plot of chunk mo_lm_2x2w_plot_std1_tumble](mo_lm_2x2w_plot_std1_tumble-1.png)
...
![plot of chunk mo_lm_2x2w_plot_std2_tumble](mo_lm_2x2w_plot_std2_tumble-1.png)
