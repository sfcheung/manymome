---
title: "Latent Variable Moderation by SAM"
...
Only the latent variables `fx`, `fm`,
...
The moderation effect is modeled by
...
below the mean, the indirect effect is
-0.032,
with a 95% confidence interval
[-0.154, 0.092].

When `fw` is one standard deviation
above the mean, the indirect effect is
0.448,
with a 95% confidence interval
[0.322, 0.593].
...
When `fw` is one standard deviation
below the mean, the standardized indirect effect is
-0.038,
with a 95% confidence interval
[-0.187, 0.112].
...
axes. This is because they differ merely
only in the units of the variables,
one standardized and one unstandardized.

Please see the [help page](https://sfcheung.github.io/manymome/reference/plot.cond_indirect_effects.html)
of the `plot()`
