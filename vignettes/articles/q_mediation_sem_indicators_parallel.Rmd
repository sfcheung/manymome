---
title: "Parallel Mediation Models Corrected for Measurement Error"
...
We would like to fit the model above,
...
- `indicators`: The indicators for latent
  ...
  of the latent factors, it is an observed
  variable.
...
These are the results for predicting `fm1`
and `fm2`:
