...
![plot of chunk mo_lm_cat_2w_gp](mo_lm_cat_2w_gp-1.png)
...
#>  - [CI.lo to CI.hi] are 95.0% confidence interval computed from regression standard
#>    errors.
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp](mo_lm_cat_2w_plot_cond_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_tumble](mo_lm_cat_2w_plot_cond_gp_tumble-1.png)
...
#> 
#>  - [CI.lo to CI.hi] are 95.0% percentile confidence intervals by nonparametric
...
![plot of chunk mo_lm_cat_2w_plot_std_gp](mo_lm_cat_2w_plot_std_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_gp_tumble](mo_lm_cat_2w_plot_std_gp_tumble-1.png)
...
![plot of chunk mo_lm_cat_2w_site](mo_lm_cat_2w_site-1.png)
...
``` r
lm_y_site <- lm(y ~ site*x + c1 + c2, dat)
```
...
Let's use `do_boot()` again:


``` r
boot_out_site <- do_boot(
  lm_y_site,
  R = 5000,
  seed = 54532
)
...
![plot of chunk mo_lm_cat_2w_plot_cond_site](mo_lm_cat_2w_plot_cond_site-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_site_tumble](mo_lm_cat_2w_plot_cond_site_tumble-1.png)
...
such a cross-over of the lines happen in the
*populations*).
...
![plot of chunk mo_lm_cat_2w_plot_std_site](mo_lm_cat_2w_plot_std_site-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_site_tumble](mo_lm_cat_2w_plot_std_site_tumble-1.png)
...
![plot of chunk mo_lm_cat_2w_gp_site](mo_lm_cat_2w_gp_site-1.png)
...
``` r
lm_y_gp_site <- lm(y ~ gp*x + site*x + c1 + c2, dat)
```
...
#> 
#>        [gp] [site] (gpTreatment) (siteSite 2) (siteSite 3)    ind    SE   Stat pvalue Sig  CI.lo
#> 1 Control   Site 1             0            0            0 -0.084 0.060 -1.409  0.159     -0.201
#> 2 Control   Site 2             0            1            0  0.229 0.065  3.527  0.000 ***  0.101
#> 3 Control   Site 3             0            0            1 -0.173 0.067 -2.592  0.010 **  -0.304
#> 4 Treatment Site 1             1            0            0  0.271 0.060  4.543  0.000 ***  0.154
#> 5 Treatment Site 2             1            1            0  0.584 0.064  9.146  0.000 ***  0.459
#> 6 Treatment Site 3             1            0            1  0.182 0.062  2.936  0.003 **   0.060
#>    CI.hi
#> 1  0.033
#> 2  0.356
#> 3 -0.042
...
NOTE: Even though this model does not
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_site](mo_lm_cat_2w_plot_cond_gp_site-1.png)

For two or more moderators, it is not
easy to visualize the conditional effects
if all lines plotted on the same graph.
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_site_cols_gp](mo_lm_cat_2w_plot_cond_gp_site_cols_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_site_cols_site](mo_lm_cat_2w_plot_cond_gp_site_cols_site-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_site_cols_gp_tumble](mo_lm_cat_2w_plot_cond_gp_site_cols_gp_tumble-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_site_cols_site_tumble](mo_lm_cat_2w_plot_cond_gp_site_cols_site_tumble-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_gp_site_tumble_cols_gp](mo_lm_cat_2w_plot_std_gp_site_tumble_cols_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_gp_site_tumble_cols_site](mo_lm_cat_2w_plot_std_gp_site_tumble_cols_site-1.png)
...
``` r
lm_y_gp_x_site <- lm(y ~ gp*site*x + c1 + c2, dat)
```
...
#> 
#> Call:
#> lm(formula = y ~ gp * site * x + c1 + c2, data = dat)
#> 
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
...
#> gpTreatment:siteSite 2   -1.970235   3.954140  -0.498  0.61848    
#> gpTreatment:siteSite 3    8.743721   3.254470   2.687  0.00742 ** 
#> gpTreatment:x             0.453702   0.107574   4.218 2.86e-05 ***
#> siteSite 2:x              0.222148   0.112091   1.982  0.04796 *  
#> siteSite 3:x              0.154193   0.113159   1.363  0.17352    
#> gpTreatment:siteSite 2:x  0.157510   0.159449   0.988  0.32364    
#> gpTreatment:siteSite 3:x -0.485461   0.160220  -3.030  0.00255 ** 
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
...
generated as before using `do_boot()`:


``` r
boot_out_gp_x_site <- do_boot(
  lm_y_gp_x_site,
  R = 5000,
  seed = 54532
)
...
#> 
#>        [gp] [site] (gpTreatment) (siteSite 2) (siteSite 3)    ind    SE   Stat pvalue Sig  CI.lo
#> 1 Control   Site 1             0            0            0 -0.128 0.074 -1.722  0.086     -0.274
#> 2 Control   Site 2             0            1            0  0.094 0.084  1.122  0.262     -0.071
#> 3 Control   Site 3             0            0            1  0.026 0.085  0.307  0.759     -0.141
#> 4 Treatment Site 1             1            0            0  0.326 0.078  4.190  0.000 ***  0.173
#> 5 Treatment Site 2             1            1            0  0.705 0.083  8.543  0.000 ***  0.543
#> 6 Treatment Site 3             1            0            1 -0.006 0.082 -0.069  0.945     -0.167
#>   CI.hi
#> 1 0.018
#> 2 0.259
#> 3 0.193
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_x_site_cols_gp](mo_lm_cat_2w_plot_cond_gp_x_site_cols_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_cond_gp_x_site_cols_site](mo_lm_cat_2w_plot_cond_gp_x_site_cols_site-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_gp_x_site_tumble_cols_gp](mo_lm_cat_2w_plot_std_gp_x_site_tumble_cols_gp-1.png)
...
![plot of chunk mo_lm_cat_2w_plot_std_gp_x_site_tumble_cols_site](mo_lm_cat_2w_plot_std_gp_x_site_tumble_cols_site-1.png)
