...
(Parallel processing multiple regression
is not yet
available in the CRAN version. Please
[install the GitHub version](https://sfcheung.github.io/manymome/#installation)
to use `ncores` with `lm()` outputs.)
...
(This section is on functions not yet
available in the CRAN version. Please
[install the GitHub version](https://sfcheung.github.io/manymome/#installation)
