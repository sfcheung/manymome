...
the regression outputs can be combined in a valid way.
...
The output is an `all_paths`-class object.
...
name as it appears in the output.
Individual indirect
...
of `indirect`-class objects. `x` is the
