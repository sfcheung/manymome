...
(w1)](mo_lm_2x2w_plot_cond1-1.png)

Conventional Plot of Conditional Effects (w1)
...
![Conventional Plot of Conditional Effects
(w2)](mo_lm_2x2w_plot_cond2-1.png)

Conventional Plot of Conditional Effects (w2)
...
(w1)](mo_lm_2x2w_plot_cond1_tumble-1.png)
...
![Tumble Plot of Conditional Effects
(w2)](mo_lm_2x2w_plot_cond2_tumble-1.png)

Tumble Plot of Conditional Effects (w2)

In this example, the distributions of `x2` for the three levels of
moderator `w2` are similar. For `x2`, the conventional graph is
sufficient.
...
The standardized conditional effects from `x1` and `x2` to `y`
conditional on `w1` and `w2` can be estimated by setting
...
(w1)](mo_lm_2x2w_plot_std1-1.png)

Conventional Plot of Standardized Conditional Effects (w1)
...
![Conventional Plot of Standardized Conditional Effects
(w2)](mo_lm_2x2w_plot_std2-1.png)

Conventional Plot of Standardized Conditional Effects (w2)
...
(w1)](mo_lm_2x2w_plot_std1_tumble-1.png)

Tumble Plot of Standardized Conditional Effects (w1)
...
![Tumble Plot of Standardized Conditional Effects
(w2)](mo_lm_2x2w_plot_std2_tumble-1.png)

Tumble Plot of Standardized Conditional Effects (w2)
