...
fit_mc_out <- do_mc(fit, R = 1000, seed = 34143)
...
fit_mc_out <- do_mc(fit, R = 100, seed = 5155)
...
suppressWarnings(out_5_mc2 <- cond_indirect_effects(wlevels = out_mm_1, x = "x", y = "y", m = "m3", fit = fit,
