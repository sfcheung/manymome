...
#'
#' @details Merge the levels of moderators generated by
#'  [mod_levels()] into a data frame, with each row
#'  represents a combination of the levels. The output is
#'  to be used by [cond_indirect_effects()].
#'
...
#'
#' @return A data frame of the combinations of levels.
#'
